...
export default function ProjectsPage() {
  ...
  const staticProjects: Project[] = [
    ...
    },
    {
      ...
      websiteUrl: 'https://www.tmu.ai',
      imageUrl: '/assets/generated/tmu-enablement-platform-project.dim_400x250.png',
      status: 'active'
    },
    {
      id: BigInt(1010),
              ...
              >
                ...
                <CardContent className="pt-0 pb-6 space-y-3">
                  {project.status === 'coming-soon' ? (
                    ...
                    // Special layout for Morshid with 6 buttons in 3 rows
                    <div className="space-y-3">
                      ...
                      {/* Row 2 and Row 3: Additional buttons */}
